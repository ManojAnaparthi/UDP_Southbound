...
struct vteprec_acl *
vteprec_acl_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_acl_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_acl, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_acl_entry *
vteprec_acl_entry_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_acl_entry_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_acl_entry, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_arp_sources_local *
vteprec_arp_sources_local_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_arp_sources_local_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_arp_sources_local, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_arp_sources_remote *
vteprec_arp_sources_remote_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_arp_sources_remote_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_arp_sources_remote, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_global *
vteprec_global_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_global_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_global, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_logical_binding_stats *
vteprec_logical_binding_stats_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_logical_binding_stats_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_logical_binding_stats, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_logical_router *
vteprec_logical_router_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_logical_router_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_logical_router, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_logical_switch *
vteprec_logical_switch_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_logical_switch_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_logical_switch, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_manager *
vteprec_manager_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_manager_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_manager, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_mcast_macs_local *
vteprec_mcast_macs_local_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_mcast_macs_local_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_mcast_macs_local, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_mcast_macs_remote *
vteprec_mcast_macs_remote_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_mcast_macs_remote_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_mcast_macs_remote, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_physical_locator *
vteprec_physical_locator_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_physical_locator_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_physical_locator, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_physical_locator_set *
vteprec_physical_locator_set_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_physical_locator_set_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_physical_locator_set, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_physical_port *
vteprec_physical_port_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_physical_port_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_physical_port, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_physical_switch *
vteprec_physical_switch_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_physical_switch_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_physical_switch, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_tunnel *
vteprec_tunnel_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_tunnel_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_tunnel, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_ucast_macs_local *
vteprec_ucast_macs_local_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_ucast_macs_local_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_ucast_macs_local, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct vteprec_ucast_macs_remote *
vteprec_ucast_macs_remote_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return vteprec_ucast_macs_remote_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &vteprec_table_ucast_macs_remote, uuid));
}
