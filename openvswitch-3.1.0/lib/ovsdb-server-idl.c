...
struct serverrec_database *
serverrec_database_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return serverrec_database_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &serverrec_table_database, uuid));
}
