...
struct idltest_indexed *
idltest_indexed_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_indexed_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_indexed, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_link1 *
idltest_link1_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_link1_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_link1, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_link2 *
idltest_link2_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_link2_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_link2, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple *
idltest_simple_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple2 *
idltest_simple2_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple2_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple2, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple3 *
idltest_simple3_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple3_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple3, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple4 *
idltest_simple4_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple4_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple4, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple5 *
idltest_simple5_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple5_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple5, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple6 *
idltest_simple6_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple6_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple6, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_simple7 *
idltest_simple7_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_simple7_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_simple7, uuid));
}
 ...
 * UUID when 'txn' is committed. */
struct idltest_singleton *
idltest_singleton_insert_persist_uuid(struct ovsdb_idl_txn *txn, const struct uuid *uuid)
{
    return idltest_singleton_cast(ovsdb_idl_txn_insert_persist_uuid(
        txn, &idltest_table_singleton, uuid));
}
