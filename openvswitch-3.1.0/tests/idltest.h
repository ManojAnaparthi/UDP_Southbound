...
struct idltest_indexed *idltest_indexed_insert_persist_uuid(
...
struct idltest_link1 *idltest_link1_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_link2 *idltest_link2_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple *idltest_simple_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple2 *idltest_simple2_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple3 *idltest_simple3_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple4 *idltest_simple4_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple5 *idltest_simple5_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple6 *idltest_simple6_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_simple7 *idltest_simple7_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
...
struct idltest_singleton *idltest_singleton_insert_persist_uuid(
    struct ovsdb_idl_txn *txn, const struct uuid *uuid);
